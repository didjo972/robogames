...
public class RGServiceFactory extends AbstractServiceFactory {
    ...
    /**
     * Méthode qui créee et renvoie un objet de type DebriefService.
     * @return un service exposant les méthodes de haut niveau pour les actions sur les objets de type DebriefService
     */
    public DebriefService getDebriefService(){
    	return (DebriefService) getContext().getBean("debriefService");
    }
